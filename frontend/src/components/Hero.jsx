...
import { assets, cities } from '../assets/assets'; // Ensure cities is properly exported
...
const Hero = () => {
  return (
    ...
    >
      ...
      <h1 className='font-platfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>
